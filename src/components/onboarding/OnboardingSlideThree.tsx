...
export function OnboardingSlideThree({ onFinish }: OnboardingSlideThreeProps) {
  ...
  return (
    <View className="flex-1 bg-[#101622] px-6 pt-12 pb-8 justify-between">
      ...
      <View className="items-center w-full flex-1 justify-center">
        {/* --- VISUALIZATION CARD --- */}
        <View className="relative w-full aspect-square max-w-95 mb-8 items-center justify-center">
          ...
          >
            {/* Card Header */}
            <View className="flex-row justify-between items-center mb-8 opacity-40 ">
          ...
          <View className="absolute -bottom-5 bg-[#1a2230] border border-white/10 px-5 py-3 rounded-full shadow-xl flex-row items-center gap-2 z-20">
        ...
        <View className="mt-6 items-center px-4">
          ...
          <Text className="text-slate-400 text-center text-base leading-relaxed max-w-70">
